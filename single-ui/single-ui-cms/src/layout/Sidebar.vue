...
<template>
  <div class="w-1/2 md:w-1/3 lg:w-64 fixed md:top-0 md:left-0 h-screen hidden lg:block bg-white z-30" id="main-nav">
    <div class="w-full h-20 border-b flex px-4 items-center mb-8">
      <p class="">
        <img src="../assets/logo2.png" class="w-[45%]" >
      </p>
    </div>

    <div class="mb-4 px-4 text-gray-600">
      <p class="pl-4 text-xs font-semibold mb-1">MAIN</p>
      <div class="w-full flex items-center text-gray-600 h-10 pl-4 bg-green-200 hover:bg-gray-200 rounded-lg cursor-pointer">
      ...
      <div class="w-full flex items-center h-10 pl-4 hover:bg-gray-200 rounded-lg cursor-pointer">
        <svg class="h-4 w-4 fill-current mr-2" viewBox="0 0 20 20">
      ...
      <div class="w-full flex items-center h-10 pl-4 hover:bg-gray-200 rounded-lg cursor-pointer">
        ...
        <span class="text-xs">Enquiries</span>
      </div>
      <div class="w-full flex items-center h-10 pl-4 hover:bg-gray-200 rounded-lg cursor-pointer">
        <svg class="h-4 w-4 fill-current mr-2" viewBox="0 0 20 20">
    ...
    <div class="mb-4 px-4 text-gray-600">
      <p class="pl-4 text-xs font-semibold mb-1">PRODUCTS</p>
      <div class="w-full flex items-center h-10 pl-4 hover:bg-gray-200 rounded-lg cursor-pointer">
        <svg class="h-4 w-4 fill-current mr-2" viewBox="0 0 20 20">
      ...
      <div class="w-full flex items-center h-10 pl-4 hover:bg-gray-200 rounded-lg cursor-pointer">
        ...
        <span class="text-xs">View Products</span>
      </div>
    </div>

    <div class="mb-4 px-4 text-gray-600">
      <p class="pl-4 text-xs font-semibold mb-1">MISC</p>
      <div class="w-full flex items-center h-10 pl-4 hover:bg-gray-200 rounded-lg cursor-pointer">
        <svg class="h-4 w-4 fill-current mr-2" viewBox="0 0 20 20">
    ...
    <div class="absolute bottom-0 w-full h-12 mb-12 flex flex-col justify-items-center border-t " @click="onSettings()">
      <div class="my-8 flex flex-row hover:bg-gray-100 mx-1 rounded-md cursor-pointer">
        <div class="flex-none ml-4">
          <img src="https://images.pexels.com/photos/4584664/pexels-photo-4584664.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2" class="w-10 h-10 rounded-full shadow-lg">
        </div>

        <div class="ml-2 text-left flex-grow">
          <div class="flex-col text-[12px] text-gray-800">
            <div>
    ...
    <div class="transition absolute bg-white border shadow-xl text-gray-700 rounded w-48 bottom-8 left-56 mr-6" :class="modalSettings ? '' : 'hidden'">
        <a href="#" class="block px-4 py-2 hover:bg-gray-200">Account</a>
        <a href="#" class="block px-4 py-2 hover:bg-gray-200">Settings</a>
        <a href="#" class="block px-4 py-2 hover:bg-gray-200" @click="onLogout()">Logout</a>
    </div>
  </div>
</template>
...
export default defineComponent({
  ...
  setup() {
    ...
    const onSettings = () => {
      modalSettings.value ? modalSettings.value = false : modalSettings.value = true; 
    } 
